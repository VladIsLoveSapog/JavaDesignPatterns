...
**Технический комментарий, понятный только автору:**
...
вызывающем методе логика выполняется только при ненулевом значении. В данном случае метод *getSourceColumnFromHeader*
должен возвращать *Optional\<Integer\>*.
